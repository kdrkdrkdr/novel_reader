...
if __name__ == "__main__":
    main()
# https://app-api.pixiv.net/web/v1/users/auth/pixiv/callback?state=C6zXBRseYj2dzZNPNvJQopZPfshVTY7UWz6IyjR411aK89Hkc6wHK1541RDW5WdC&code=1kzzSsV8bNP8jO7F-hMOV46xmoc0PE5WCFbdiNOXKqQ
